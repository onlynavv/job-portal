...
const JobCard = ({_id, applicants, deadline, jobtitle, jobtype, noofapplicants, positions, postedOn, recruiterEmail, recruiterLocation, recruiterName, salary, skillsets, workexperience, requirementList, jobdesc, getJobListing}) => {
